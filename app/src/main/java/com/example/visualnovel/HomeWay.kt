...
import kotlinx.android.synthetic.main.activity_home_way.*


class HomeWay : AppCompatActivity(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mQuestionsList = ConstantsHomeWay.getQuestions()
        setQuestion()
                ...
                if (mSelectedOptionPosition == 0) {
                    ...
                    when {
                        ...
                        mCurrentPosition <= mQuestionsList!!.size -> {
                            ...
                            // START
                            val intent =
                                Intent(this@HomeWay, ResumeActivity::class.java)
